...
class StarshipAdapter(private val iAdapterItemListener: IAdapterItemListener<Starship>): RecyclerView.Adapter<StarshipAdapter.ViewHolder>() {

    var data =  listOf<Starship>()
        set(value) {
            field = value
