...
class StarshipPilotAdapter(private val iAdapterItemListener: IAdapterItemListener<String>) :
    RecyclerView.Adapter<StarshipPilotAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val tempText = "Pilot " + Utils().getIdFromString(item)
